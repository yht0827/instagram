...
class LikeImage(APIView):
    ...
    def get(self, request, image_id, _format=None):
    ...
    def post(self, request, image_id, _format=None):
...
class UnLikeImage(APIView):
    ...
    def delete(self, request, image_id, _format=None):
...
class Comment(APIView):
    ...
    def delete(self, request, comment_id, _format=None):
...
class ModerateComments(APIView):
    ...
    def delete(self, request, image_id, comment_id, _format=None):
...
class ImageDetail(APIView):
    ...
    def put(self, request, image_id, _format=None):
